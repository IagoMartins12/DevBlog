      ...
      <section className='w-full md:pt-[100px] md:pb-[70px] pt-[130px] pb-20 mb-10 dark:bg-slate-800 bg-slate-200'>
        <div className="container text-center px-3">
          ...
          <Text p className="mt-3 text-xl">
            Um blog onde irei documentar meus estudos e experiencias na minha trajetoria na area de desenvolvimento 
          </Text>

          <div className='flex justify-center mt-5 flex-wrap '>
            <a href="https://github.com/IagoMartins12/Personal-Blog" target="_blank" rel="noopener noreferrer" className='flex items-center justify-center rounded-md bg-blue-600 px-4 pb-2 text-white hover:text-white shadow-lg hover:shadow-none transition-all mb-3 md:mx-5 mx-2'>
            ...
            <LinkTo href="/pages/contact-me.tsx" passHref className='flex items-center justify-center rounded-md bg-blue-600 px-4 pb-2 text-white hover:text-white shadow-lg hover:shadow-none transition-all mb-3 md:mx-5 mx-2'>
              <span className='text-xl pt-2 block'>Contact</span>
            </LinkTo>
          </div>
        </div>
      </section>
